...
$('a.icon_prediction').hover(
  function() {
    $('img#icon_prediction').attr(
      'src',
      '/static/media/img/icon_prediction_selected_{{ g.color }}.png'
    );
  ...
  function() {
    $('img#icon_prediction').attr(
      'src',
      '/static/media/img/icon_prediction.png'
    );
    $('a.icon_prediction').css('color', '#000');
  }
);

$('a.icon_community').hover(
  function() {
    $('img#icon_community').attr(
      'src',
      '/static/media/img/icon_community_selected_{{ g.color }}.png'
    );
    $('a.icon_community').css('color', '{{ g.color_code }}');
  },
  function() {
    $('img#icon_community').attr(
      'src',
      '/static/media/img/icon_community.png'
    );
    $('a.icon_community').css('color', '#000');
  }
);
...
$('a.icon_map').hover(
  function() {
    $('img#icon_map').attr(
      'src',
      '/static/media/img/icon_map_selected_{{ g.color }}.png'
    );
...
$('.nav span a').click(function() {
  ...
  $('span.menu_community').toggleClass('selected', false);
  $(this)
    .parent()
  ...
  afterMove: function(index) {
    ...
    switch (current_index) {
      ...
      case 4:
        ...
        break;
      case 5:
        $('span.menu_community').toggleClass('selected', true);
...
$('a.menu_community').click(function() {
  $('.main').moveTo(5);
});
...
$('a.icon_community').click(function() {
  $('.main').moveTo(5);
});
...
function drawMap() {
  ...
  function ready(error, world) {
    ...
    borders = topojson.mesh(worldData, worldData.objects.countries, function(
      a,
      b
    ) {
      return a !== b;
